...
import com.page.GoodsPage;
import com.page.MainPage;
import com.page.SalesManPage;

/**
 * 1.各種完成操作后的 选择下一步 2.界面选择操作
 */
public class ScannerChoice {
	...
	public static void changedInfoNext(String oper) {
		do {
			...
			if("y".equals(choice)||"Y".equals(choice)) {//在JAVA中: Equals比较的是值,==比较的是地址if ("upateGoodsPage".equals(oper))
				{
					GoodsPage.upateGoodsPage();
				}if ("deleteGoodsPage".equals(oper)){
